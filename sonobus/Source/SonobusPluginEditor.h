...
private:
    ...
    void showVideoRelayView(bool show, bool fromVideoButton=true);
    void copyGroupLink();
    ...
    std::unique_ptr<VideoRelayView> mVideoRelayView;
    ...
    WeakReference<Component> videoRelayViewCalloutBox;

...
protected:
    ...
    std::unique_ptr<ToggleButton> mRelayServerEnabledButton;
    std::unique_ptr<Label> mRelayServerStaticLabel;
    std::unique_ptr<TextEditor> mRelayServerEditor;
